function [TrialInfo, SaveFile] = NicoStim(SaveFile, varargin)
...
gd.Controls.linearMotorPos = uicontrol(...
    'Style',                'edit',...
    'String',               '0',...
...
% linear motor move
gd.Controls.linearMotorMove = uicontrol(...
    'Style',                'pushbutton',...
    'String',               'move',...
    'Parent',               gd.Controls.panel,...
    'Units',                'normalized',...
...
gd.Controls.linearMotorText = uicontrol(...
    'Style',                'text',...
    'String',               'Move linear motor (absolute)',...
    'Parent',               gd.Controls.panel,...

function [] = sbxcomputeci(ImageFile)
...
function [c,xray] = doOneBlock(ImageFile,imsize,res,winsize,T,Q,s,nframes,rg,thestd)
...
for nn = rg
    ...
    A = load2P(ImageFile,'Frames',idx(1),'Double');        % load frame

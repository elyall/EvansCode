function [m,v,T] = sbxalignpar(ImageFile,thestd,gl,l)
...
% T - optimal translation for each frame
    ...
    [A,~,Config] = load2P(ImageFile,'Frames',1);
    ...
    parfor ii = 1:nblocks
        ...
        [ms(:,:,ii),vs(:,:,ii),Ts{ii}] = sbxalignsub(ImageFile,subrg,rg1,rg2,thestd,gl,l);   
...
function [m,v,T] = sbxalignsub(ImageFile,idx,rg1,rg2,thestd,gl,l)

    if(length(idx)==1)



        A = load2P(ImageFile,'Frames',idx(1),'Double');
    ...
    elseif (length(idx)==2)
        ...
        B = load2P(ImageFile,'Frames',idx(2),'Double');
        ...
        [A,v1,T0] = sbxalignsub(ImageFile,idx0,rg1,rg2,thestd,gl,l);

        [B,v2,T1] = sbxalignsub(ImageFile,idx1,rg1,rg2,thestd,gl,l);
